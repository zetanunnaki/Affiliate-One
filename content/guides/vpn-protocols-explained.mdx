...
citations:
  ...
  - "OpenVPN Security Overview — OpenVPN Inc. https://openvpn.net/security-overview/"
  - "NIST SP 800-77 Rev.1: Guide to IPsec VPNs. https://csrc.nist.gov/publications/detail/sp/800-77/rev-1/final"
  - "D. Migault et al., A Performance Analysis of WireGuard, IEEE International Conference on Communications (2022)"
...
| Lightway | Excellent | Excellent | FastestVPN users | 2021 |
...
### Lightway (FastestVPN)
FastestVPN's custom protocol using wolfSSL for encryption. Open-source and independently audited. Designed for fast connections with small code footprint. Available only on FastestVPN apps.
