...
export const metadata: Metadata = {
  ...
  description: "Every VPN free trial and money-back guarantee in one place. Test NordVPN, Surfshark, ExpressVPN risk-free for 30 days.",
};
...
export default function VpnFreeTrialPage() {
  const trials = [
    ...
    { name: "ExpressVPN", trial: "7-day free trial (mobile only)", guarantee: "30-day money-back", free: "No", notes: "Mobile free trial on Android and iOS. All plans include 30-day money-back guarantee." },
  ...
  const faqs = [
    { question: "Which VPN has the best free trial?", answer: "Proton VPN offers the only truly free VPN tier from a reputable provider — no data caps, no speed throttle, no time limit. For paid VPN trials, Surfshark and ExpressVPN offer 7-day free trials on mobile." },
