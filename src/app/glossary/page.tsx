...
const terms = [
  ...
  { term: "RAM-Only Servers", definition: "VPN servers that run entirely in RAM with no hard drives. All data is wiped on reboot. Used by NordVPN, ExpressVPN, and Surfshark for enhanced privacy." },
