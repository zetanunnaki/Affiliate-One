...
export default function MobileSecurityPage() {
  const faqs = [
    ...
    { question: "Should I use a VPN on my phone?", answer: "Yes, especially on public Wi-Fi. Mobile VPN apps from NordVPN, Surfshark, and ExpressVPN are lightweight and have minimal battery impact with WireGuard protocol. Enable auto-connect for Wi-Fi networks." },
