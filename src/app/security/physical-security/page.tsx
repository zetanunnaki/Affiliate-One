...
export const metadata: Metadata = {
  ...
  description:
    "Digital security is useless if someone steals your laptop. Physical security practices for home offices, co-working spaces, cafés, and travel.",
  alternates: { canonical: "/security/physical-security/" },
  openGraph: {
    title: "Physical Security for Remote Workers (2026) — Protect Your Devices IRL",
