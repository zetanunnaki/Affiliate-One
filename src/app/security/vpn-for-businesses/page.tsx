...
export default function VpnForBusinessesPage() {
  ...
  const businessFeatures = [
    { feature: "Centralized management", nordvpn: "Yes (Teams/Business)", surfshark: "Yes (Surfshark One)", protonvpn: "Yes (Business)", fastestvpn: "Limited" },
    { feature: "Dedicated IP", nordvpn: "$3.69/mo extra", surfshark: "$3.75/mo extra", protonvpn: "Included (Business)", fastestvpn: "$1.66/mo extra" },
    { feature: "Team accounts", nordvpn: "Yes", surfshark: "Yes", protonvpn: "Yes", fastestvpn: "No" },
    { feature: "IP whitelisting", nordvpn: "Via dedicated IP", surfshark: "Via dedicated IP", protonvpn: "Via dedicated IP", fastestvpn: "Via dedicated IP" },
    { feature: "SSO integration", nordvpn: "Enterprise only", surfshark: "No", protonvpn: "Business plan", fastestvpn: "No" },
    { feature: "Unlimited devices", nordvpn: "No (10 cap)", surfshark: "Yes", protonvpn: "No (10 cap)", fastestvpn: "No (15 cap)" },
  ];
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <header className="mb-8">
        ...
        <Byline authorId="sarah-chen" updatedAt="2026-04-05" />
      </header>
      {/* Our Top 4 Picks */}
