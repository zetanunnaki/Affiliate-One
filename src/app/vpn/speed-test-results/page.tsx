...
export default function SpeedTestResultsPage() {
  const results = [
    ...
    { provider: "FastestVPN", protocol: "WireGuard", local: { dl: "820", ul: "680", ping: "9" }, nearby: { dl: "710", ul: "590", ping: "22" }, cross: { dl: "450", ul: "320", ping: "105" }, opposite: { dl: "260", ul: "170", ping: "190" }, avg: "82%" },
    ...
    { provider: "Proton VPN", protocol: "WireGuard", local: { dl: "740", ul: "600", ping: "8" }, nearby: { dl: "620", ul: "480", ping: "22" }, cross: { dl: "350", ul: "250", ping: "105" }, opposite: { dl: "200", ul: "140", ping: "200" }, avg: "74%" },
  ];
