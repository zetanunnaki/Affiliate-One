...
export default function VpnForAndroidPage() {
  const faqs = [
    ...
    { question: "Which VPN is best for Android?", answer: "NordVPN — best Android app with NordLynx, split tunneling, Threat Protection, and Meshnet. Surfshark is the best value with unlimited devices. ExpressVPN has the most polished UI." },
      ...
      <section className="mb-10">
        ...
        <div className="space-y-3">
          {[
            ...
            { name: "ExpressVPN", badge: "Most Polished", desc: "Lightway protocol. Beautiful Material Design UI. Automatic best-server. Consistent quality." },
          ].map((p, i) => (
