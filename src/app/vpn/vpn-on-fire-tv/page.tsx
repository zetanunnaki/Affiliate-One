...
export default function VpnOnFireTvPage() {
  const faqs = [
    { question: "Can I install a VPN on Fire TV Stick?", answer: "Yes — NordVPN, Surfshark, ExpressVPN, and others have native Fire TV apps available directly from the Amazon Appstore. Installation takes 2 minutes." },
    ...
    { question: "Does this work with Roku?", answer: "Roku doesn't support VPN apps. Your only options are router-level VPN or Smart DNS. ExpressVPN's MediaStreamer (Smart DNS) is the easiest Roku solution." },
  ];
      ...
      <section className="mb-10">
        ...
        <div className="p-5 bg-zinc-50 dark:bg-zinc-800 rounded-xl">
          <ol className="space-y-2 text-sm text-zinc-700 dark:text-zinc-300">
            ...
            <li><strong>2.</strong> Search for your VPN (NordVPN, Surfshark, or ExpressVPN)</li>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-3">
          {[
            ...
            { name: "ExpressVPN", best: "Best for all devices", desc: "Fire TV app + MediaStreamer for Roku, Apple TV, and smart TVs. Most device coverage overall." },
