...
/**
 * Custom MDX components for next-mdx-remote/rsc compileMDX.
 * These are used when rendering MDX via compileMDX() since it doesn't
 * use the global mdx-components.tsx file.
 */
